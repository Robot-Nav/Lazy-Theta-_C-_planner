...
void ThetaStar::setStartAndGoalWorld(double start_wx, double start_wy,
                                      double goal_wx, double goal_wy)
{
  unsigned int sx, sy, gx, gy;
  costmap_->worldToMap(start_wx, start_wy, sx, sy);
...
void ThetaStar::setConfig(const PlannerConfig & config)
{
  ...
  how_many_corners_ = config.how_many_corners;
